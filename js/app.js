(() => {
    ...
    re(),
      document.querySelector(".swiper") &&
        (new te(".intro__body-1", {
          ...
          simulateTouch: !1,
          navigation: {
            nextEl: ".control-intro__arrow_next",
            prevEl: ".control-intro__arrow_prev",
          },
          on: {},
        }),
        new te(".lot__swiper", {
          ...
          simulateTouch: !1,
          navigation: {
            nextEl: ".controls-lots-next",
            prevEl: ".controls-lots-prev",
          },
          breakpoints: {
            320: { slidesPerView: 1, spaceBetween: 20 },
            540: { slidesPerView: 2, spaceBetween: 20 },
            768: { slidesPerView: 3, spaceBetween: 30 },
            970: { slidesPerView: 3, spaceBetween: 100 },
          },
          on: {},
        }),
        new te(".quotes__body", {
          ...
          spaceBetween: 30,
          effect: "fade",
          navigation: { prevEl: ".control-quotes__arrow" },
        }));
  });
  let ae = !1;
  setTimeout(() => {
  ...
  const oe = document.querySelector(".region-header__pick"),
    le = document.querySelector(".region-submenu__list");
  oe.addEventListener("click", function (e) {
    le.classList.toggle("list-active"), e.preventDefault();
  }),
    document.documentElement.addEventListener("click", function (e) {
      e.target.closest(".region-header__pick") ||
        le.classList.remove("list-active");
    });
  const de = document.querySelectorAll(".menu__link[data-goto]");
    ...
    de.forEach((e) => {
      e.addEventListener("click", function (e) {
        ...
        if (t.dataset.goto && document.querySelector(t.dataset.goto)) {
          ...
          ce.classList.contains("menu-open") &&
            (ce.classList.remove("lock"), ce.classList.remove("menu-open")),
